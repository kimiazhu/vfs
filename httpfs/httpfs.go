...
// Package httpfs implements http.FileSystem using a vfs.FileSystem.
package httpfs // import "github.com/kimiazhu/vfs/httpfs"
...
func (h *httpDir) Stat() (os.FileInfo, error) {
